...
export = {
    ...
    "bot.angry": "<b>ε٩(๑> ₃ <)۶з 有人抢走了我的管理员权限，我不开心了。</b>",
    ...
    "fail.help": "/fail - 回复某用户的消息或者Ta的验证消息，强制使该待验证用户验证失败",
    ...
    "open_source.help": "此项目开源于: https://git.io/Jt10S ",
    "pass.help": "/pass - 回复某用户的消息或者Ta的验证消息，使该待验证用户跳过验证",
