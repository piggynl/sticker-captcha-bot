...
export = {
    ...
    "bot.angry": "<i>Somebody has taken my admin privileges away. I'm unhappy.</i>",
    ...
    "cmd.not_admin": "Only admins with <i>ban users</i> privilege are allowed to use this command",
    ...
    "onjoin.default": "Hi $u, please send any sticker within $t seconds to complete the verification",
